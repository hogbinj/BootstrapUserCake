...
<link href='css/signin.css' rel='stylesheet'>
	<div class='container'>
		<form name='updateAccount' action='".$_SERVER['PHP_SELF']."' method='post' class='form-signin' role='form'>
			<h2 class='form-signin-heading'>Update Information</h2>
			<input type='text' class='form-control' placeholder='e-mail' name='email' value='".$loggedInUser->email."' />
